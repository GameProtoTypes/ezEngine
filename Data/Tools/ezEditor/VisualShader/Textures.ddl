...
Texture2D BaseTexture BIND_SET(SET_MATERIAL);
SamplerState BaseTexture_AutoSampler BIND_SET(SET_MATERIAL);
" }
...
" }
  ...
  string %CodePixelSamplers { "
Texture2D $prop0 BIND_SET(SET_MATERIAL);
SamplerState $prop0_AutoSampler BIND_SET(SET_MATERIAL);
" }
...
Node %EmissiveTexture
{
  ...
  string %CodePixelSamplers { "
Texture2D EmissiveTexture BIND_SET(SET_MATERIAL);
SamplerState EmissiveTexture_AutoSampler BIND_SET(SET_MATERIAL);
" }
...
Node %MetallicTexture
{
  ...
  string %CodePixelSamplers { "
Texture2D MetallicTexture BIND_SET(SET_MATERIAL);
SamplerState MetallicTexture_AutoSampler BIND_SET(SET_MATERIAL);
" }
...
Node %RoughnessTexture
{
  ...
  string %CodePixelSamplers { "
Texture2D RoughnessTexture BIND_SET(SET_MATERIAL);
SamplerState RoughnessTexture_AutoSampler BIND_SET(SET_MATERIAL);
" }

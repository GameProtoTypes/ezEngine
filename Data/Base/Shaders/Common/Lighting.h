...
// Pass data
Texture2DArray SSAOTexture BIND_SET(SET_RENDER_PASS);
Texture2DArray SceneDepth BIND_SET(SET_RENDER_PASS);
Texture2DArray SceneColor BIND_SET(SET_RENDER_PASS);
SamplerState SceneColorSampler BIND_SET(SET_RENDER_PASS);
